...
datasets = {
    'coco': {
        'num_classes': 80,
        'train_imgs': 'C:\work\ProjectOsa\Detector\Dataset\image',
        'val_imgs': 'C:\work\ProjectOsa\Detector\Dataset\image',
        'train_anno': 'C:\work\ProjectOsa\Detector\Dataset/annotation/3_coco_imglab.json',
        'val_anno': 'C:\work\ProjectOsa\Detector\Dataset/annotation/1_coco_imglab.json',
